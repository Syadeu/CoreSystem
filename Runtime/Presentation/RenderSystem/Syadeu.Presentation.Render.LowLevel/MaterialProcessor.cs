...
{
    [RequireDerived]
    public abstract class MaterialProcessor : IMaterialProcessor, IDisposable
    {
        InstancedMaterial IMaterialProcessor.Material => InstancedMaterial.GetMaterial(Material);
