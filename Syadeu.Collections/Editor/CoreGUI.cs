...
namespace Syadeu.Collections.Editor
{
    public sealed class CoreGUI : CLRSingleTone<CoreGUI>
    {
        ...
        public static void Label(GUIContent text, TextAnchor textAnchor)
        {
        ...
        public static void Label(string text, StringColor color, TextAnchor textAnchor = TextAnchor.UpperLeft)
        {
            GUIStyle style = GetLabelStyle(textAnchor);

            text = HTMLString.String(text, color);

            EditorGUILayout.LabelField(text, style);
        }
        public static void Label(string text, TextAnchor textAnchor)
        {
            GUIStyle style = GetLabelStyle(textAnchor);
        ...
        public static void Label(string text, StringColor color, int size, TextAnchor textAnchor = TextAnchor.UpperLeft)
        {
            GUIStyle style = GetLabelStyle(textAnchor);

            text = HTMLString.String(text, color, size);
        ...
        public static void Label(Rect rect, GUIContent text, int size, TextAnchor textAnchor)
        {
            ...
            temp.text = HTMLString.String(text.text, size);
        ...
        {
            EditorGUI.LabelField(rect, HTMLString.String(text, size), GetLabelStyle(textAnchor));
        }
        ...
        public static bool Foldout(bool foldout, string name, int size = -1)
        {
            ...
            {
                return EditorGUILayout.Foldout(foldout, HTMLString.String($"{firstKey} {name}", StringColor.grey, size), true, EditorStyleUtilities.HeaderStyle);
            }
        }
