...
namespace Syadeu.Collections.Editor
{
    public static class SerializedPropertyHelper
    {
        ...
        public static FixedReference ReadReference(SerializedProperty property)
        {
            SerializedProperty hashProp = property.FindPropertyRelative("m_Hash");
            return new FixedReference(ReadHash(hashProp));
        }
        public static FixedReference<T> ReadReference<T>(SerializedProperty property)
            where T : class, IObject
        {
            SerializedProperty hashProp = property.FindPropertyRelative("m_Hash");
            return new FixedReference<T>(ReadHash(hashProp));
        }
        public static void SetReference(SerializedProperty property, FixedReference reference)
        {
            SerializedProperty hashProp = property.FindPropertyRelative("m_Hash");
            SetHash(hashProp, reference.Hash);
        }
