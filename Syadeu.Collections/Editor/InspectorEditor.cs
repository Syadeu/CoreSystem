...
namespace Syadeu.Collections.Editor
{
    ...
    public abstract class InspectorEditor : UnityEditor.Editor
    {
        ...
        {
            CoreGUI.Label(new GUIContent("Copyright 2022 Syadeu. All rights reserved."), 11, TextAnchor.MiddleCenter);
            CoreGUI.Label("CoreSystem®", 11, TextAnchor.MiddleCenter);
        ...
        {
            CoreGUI.Label(GetHeaderName(), 20);
            CoreGUI.Line();
